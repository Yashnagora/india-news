...
const updateNews = async () => {
  props.setprogress(0);
  const url = `https://newsapi.org/v2/top-headlines?country=${props.country}&category=${props.category}&apiKey=09fd7a00eb1f41bab701de65ef467cd8&page=${page}&pageSize=${props.pageSize}`
  setloading(true);
